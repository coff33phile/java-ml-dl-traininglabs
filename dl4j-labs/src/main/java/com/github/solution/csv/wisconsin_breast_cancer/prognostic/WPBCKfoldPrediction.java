...
public class WPBCKfoldPrediction {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        log = TrainingLogger.loggerSetup(WPBCKfoldPrediction.class.getName());
        ...
        KFoldIterator kFoldIterator = new KFoldIterator(kfold, dataset);
        ...
        while (kFoldIterator.hasNext()){
            ...
            System.out.println("Train F1: " + trainEval.f1());
            System.out.println("Train Confusion matrix: \n" + trainEval.confusionMatrix());
            trainF1List.add(trainEval.f1());

            Evaluation valEval = model.evaluate(valIter);
            System.out.println("Validation Accuracy: " + valEval.accuracy());
            System.out.println("Validation F1: " + valEval.f1());
            System.out.println("Validation Confusion matrix: \n" + valEval.confusionMatrix());
            valF1List.add(valEval.f1());
